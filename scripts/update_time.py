...
<desc id="desc">Updated {now:%d %B %Y at %H:%M} in Dhaka, UTC plus six. Year {progress:.1%} complete, {days_left} calendar days until January 1. Saved snapshot; this is not a live clock.</desc>
<rect x="1" y="1" width="1198" height="308" rx="18" fill="#090e1b" stroke="#2c3d56"/>
<g font-family="Arial, Helvetica, sans-serif">
<circle cx="48" cy="37" r="5" fill="#50f5e9"/>
<text x="64" y="42" font-size="12" letter-spacing="2" fill="#50f5e9">TIME SNAPSHOT / DHAKA</text>
...
{segments}
<text x="42" y="289" font-size="12" fill="#9aabc6">SNAPSHOT · {now:%Y-%m-%d %H:%M} DHAKA · SAVED SNAPSHOT</text>
